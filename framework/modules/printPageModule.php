	...
	function generateHead(){
        ...
        foreach($this->sourcesArray as $source){
            ...
            switch($source[0]){
                ...
                case 'javascript':
                    $sourcesString =  $sourcesString.'<script type="text/javascript" src="data/javascript/'.$source[1].'.js" ></script>'."\n";
                    break;

                case 'css':
                    $sourcesString = $sourcesString.'<link rel="stylesheet" type="text/css" href="data/css/'.$source[1].'.css">'."\n";
                    break;
